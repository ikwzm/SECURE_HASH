#--------------------------------------------------------------------------
# Avalon-ST SHA-256 component description
#--------------------------------------------------------------------------

package require -exact sopc 9.1

set_module_property NAME                         sha256_avalon_stream
set_module_property DISPLAY_NAME                 "SHA-256 Generator Avalon-ST Wrapper Module"
set_module_property AUTHOR                       "ikwzm"
set_module_property TOP_LEVEL_HDL_FILE           "../../../../src/examples/vhdl/sha256_avalon_stream.vhd"
set_module_property TOP_LEVEL_HDL_MODULE         sha256_avalon_stream
...
add_file "../../../../src/examples/vhdl/sha256_avalon_stream.vhd" {SYNTHESIS SIMULATION}
