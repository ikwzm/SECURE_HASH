#--------------------------------------------------------------------------
# Avalon-ST SHA-1 component description
#--------------------------------------------------------------------------

package require -exact sopc 9.1

set_module_property NAME                         sha1_avalon_stream
set_module_property DISPLAY_NAME                 "SHA-1 Generator Avalon-ST Wrapper Module"
set_module_property AUTHOR                       "ikwzm"
set_module_property TOP_LEVEL_HDL_FILE           "../../../../src/examples/vhdl/sha1_avalon_stream.vhd"
set_module_property TOP_LEVEL_HDL_MODULE         sha1_avalon_stream
...
add_file "../../../../src/examples/vhdl/sha1_avalon_stream.vhd" {SYNTHESIS SIMULATION}
...
set_parameter_property BLOCK_GAP  ALLOWED_RANGES "0 1"
